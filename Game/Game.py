...
def OnOver(winner,win):
        ...
        car2 = pygame.image.load('C:/Users/nav/Desktop/CarRacing/Assets/Car3.jpg')
        car2 = pygame.transform.scale(car2,(car1.get_width(),car1.get_height()))
        car3 = pygame.image.load('C:/Users/nav/Desktop/CarRacing/Assets/Car4.jpg')
        car3 = pygame.transform.scale(car3,(car1.get_width(),car1.get_height()))
        car4 = pygame.image.load('C:/Users/nav/Desktop/CarRacing/Assets/Car5.jpg')
        car4 = pygame.transform.scale(car4,(car1.get_width(),car1.get_height()))
        car5 = pygame.image.load('C:/Users/nav/Desktop/CarRacing/Assets/CarL.jpg')
...
def basic():
    ...
    bg_img = pygame.image.load('C:/Users/nav/Desktop/CarRacing/Assets/Background.jpg')
    bg_img = pygame.transform.scale(bg_img, (WIDTH, HEIGHT))
    pygame.display.set_caption("Car-Racing")
    track1 = pygame.image.load('Assets/Track1.jpg')
    track1 = pygame.transform.scale(track1, (track_width, track_height))
    track2 = pygame.image.load('C:/Users/nav/Desktop/CarRacing/Assets/Track2.jpg')
    track2 = pygame.transform.scale(track1, (track_width, track_height))
    track3 = pygame.image.load('C:/Users/nav/Desktop/CarRacing/Assets/Track3.jpg')
    track3 = pygame.transform.scale(track1, (track_width, track_height))
    track4 = pygame.image.load('C:/Users/nav/Desktop/CarRacing/Assets/Track4.jpg')
    track4 = pygame.transform.scale(track1, (track_width, track_height))
    track5 = pygame.image.load('C:/Users/nav/Desktop/CarRacing/Assets/Track4.jpg')
